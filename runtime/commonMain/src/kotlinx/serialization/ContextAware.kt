 ...
 * It _may_ be `null` for descriptors of aforementioned kinds, if captured class information is unavailable for various reasons.
 * It means that correct schema introspection could not be performed for such a descriptor.
 *
 * ### Example
